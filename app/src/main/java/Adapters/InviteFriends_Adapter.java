...
public class InviteFriends_Adapter extends BaseAdapter
{
    Context con;
    //    ArrayList<HashMap<String, String>> list;


    public InviteFriends_Adapter(Context con/*, ArrayList<HashMap<String, String>> list*/)
    {
        this.con = con;
        //        this.list = list;
    }
    ...
    public View getView(final int position, View row, ViewGroup parent)
    {
        ...
        row = inflater.inflate(R.layout.custom_invitefriends, parent, false);
